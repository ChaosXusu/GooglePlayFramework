...
package activity.example.chaosxu.googleplayframework.ui.view;
...
public class PagerSlidingTab extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFFff0000;//指示线的颜色#006BCE
	...
	private int tabTextSize = 16;//title字体的大小
	private int tabTextColor = 0x882B2B2B;
